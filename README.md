...
Download the addon using [the next link](https://github.com/mondeja/simple-icons-blender/releases/download/15.10.0/simple_icons_blender.py):

```txt
https://github.com/mondeja/simple-icons-blender/releases/download/15.10.0/simple_icons_blender.py
```
