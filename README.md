...
Download the addon using [the next link](https://github.com/mondeja/simple-icons-blender/releases/download/13.18.0/simple_icons_blender.py):

```txt
https://github.com/mondeja/simple-icons-blender/releases/download/13.18.0/simple_icons_blender.py
```
