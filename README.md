...
Download the addon using [the next link](https://github.com/mondeja/simple-icons-blender/releases/download/8.12.1/simple_icons_blender.py):

```
https://github.com/mondeja/simple-icons-blender/releases/download/8.12.1/simple_icons_blender.py
```
...
https://user-images.githubusercontent.com/23049315/1398.12.16-a4ba9900-44bd-405f-99fd-a498161aa5ae.mp4
