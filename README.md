...
Download the addon using [the next link](https://github.com/mondeja/simple-icons-blender/releases/download/6.10.0/simple_icons_blender.py):

```
https://github.com/mondeja/simple-icons-blender/releases/download/6.10.0/simple_icons_blender.py
```
...
https://user-images.githubusercontent.com/23049315/1396.10.06-a4ba9900-44bd-405f-99fd-a498161aa5ae.mp4
